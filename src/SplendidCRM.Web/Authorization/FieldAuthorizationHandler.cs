...
{
	/// <summary>
	/// FieldAuthorizationHandler — implements part of the 4-tier ACL model (Module→Team→Field→Record).
	/// Migrated from SplendidCRM/_code/Security.cs for .NET 10 ASP.NET Core.
	/// </summary>
	public class FieldAuthorizationHandler
	{
		private readonly Security _security;
		private readonly ILogger<FieldAuthorizationHandler> _logger;

		public FieldAuthorizationHandler(Security security, ILogger<FieldAuthorizationHandler> logger)
		{
			_security = security;
			_logger = logger;
		}
