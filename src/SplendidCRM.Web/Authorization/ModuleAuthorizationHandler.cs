...
{
	/// <summary>
	/// ModuleAuthorizationHandler — implements part of the 4-tier ACL model (Module→Team→Field→Record).
	...
	public class ModuleAuthorizationHandler
	{
		...
		public ModuleAuthorizationHandler(Security security, ILogger<ModuleAuthorizationHandler> logger)
		{
			_security = security;
			_logger = logger;
		}
