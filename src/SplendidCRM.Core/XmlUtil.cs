 ...
 *********************************************************************************************************************/
// .NET 10 Migration: Replaced using System.Web with Microsoft.AspNetCore.Http and System.Net for cross-platform compatibility.
using System;
using System.IO;
using System.Data;
using System.Net;
...
namespace SplendidCRM
{
	...
	/// XML utility methods for node selection, manipulation, DataTable construction,
	/// PHP serialization conversion, XPath encoding, and XML dump rendering.
	/// </summary>
	public class XmlUtil
	{
		// .NET 10 Migration: Added IHttpContextAccessor to replace static HttpContext.Current access in Dump(XmlDocument).
		private readonly IHttpContextAccessor _httpContextAccessor;

		/// <summary>
		/// Constructor for dependency injection. Required for Dump(XmlDocument) which writes to the HTTP response.
		/// </summary>
		/// <param name="httpContextAccessor">ASP.NET Core HTTP context accessor replacing HttpContext.Current</param>
		public XmlUtil(IHttpContextAccessor httpContextAccessor)
		{
		...
		// .NET 10 Migration: Changed from static to instance method. Replaced HttpContext.Current.Server.HtmlEncode
		// with System.Net.WebUtility.HtmlEncode and HttpContext.Current.Response.Write with IHttpContextAccessor.
		public void Dump(XmlDocument xml)
		{
			StringBuilder sb = new StringBuilder();
			if ( xml != null && xml.DocumentElement != null)
				Dump(ref sb, "", xml.DocumentElement);
			string sDump = WebUtility.HtmlEncode(sb.ToString());
			HttpContext context = _httpContextAccessor?.HttpContext;
			if ( context != null )
			{
				context.Response.WriteAsync("<pre><font face='courier new'>").GetAwaiter().GetResult();
				context.Response.WriteAsync(sDump).GetAwaiter().GetResult();
				context.Response.WriteAsync("</font></pre>").GetAwaiter().GetResult();
			}
		}
