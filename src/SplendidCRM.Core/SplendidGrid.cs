...
namespace SplendidCRM
{
	...
	/// Migrated from SplendidCRM/_code/SplendidGrid.cs for .NET 10 ASP.NET Core.
	...
	public class SplendidGrid
	{
		...
		public SplendidGrid(IHttpContextAccessor httpContextAccessor, IMemoryCache memoryCache, IConfiguration configuration)
		{
