...
// .NET 10 Migration: Removed 'using Spring.Rest.Client;' and 'using Spring.Http;'
// — Spring.Social libraries have no .NET 10 equivalent; dormant Enterprise Edition stub (compile-only).
// AAP 0.8.1 Minimal Change Clause: all method signatures and XML documentation preserved exactly.
using System;
using System.IO;
