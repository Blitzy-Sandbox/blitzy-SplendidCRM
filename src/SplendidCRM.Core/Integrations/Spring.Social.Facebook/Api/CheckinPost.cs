...
namespace Spring.Social.Facebook.Api
{
	...
	// Migrated from .NET Framework 4.8 to .NET 10: removed #if !SILVERLIGHT / #endif directives;
	// [Serializable] is now applied unconditionally. Dormant Enterprise Edition stub — compile-only.
	[Serializable]
