...
namespace Spring.Social.Facebook.Api
{
	...
	// .NET 10 Migration: [Serializable] applied unconditionally — removed #if !SILVERLIGHT / #endif
	// conditional compilation directives. Silverlight is not supported in .NET 10.
	[Serializable]
