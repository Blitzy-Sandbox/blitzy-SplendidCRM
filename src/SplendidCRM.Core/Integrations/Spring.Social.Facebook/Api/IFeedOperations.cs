...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/IFeedOperations.cs
// Changes (.NET Framework 4.8 → .NET 10 ASP.NET Core migration):
//   - REMOVED: using Spring.Rest.Client; — Spring.Rest DLL has no .NET 10 equivalent; types appear only in XML doc cref attributes
//   - REMOVED: using Spring.Http; — Spring.Http DLL has no .NET 10 equivalent; not used in actual interface code
//   - KEPT: all using System.* imports unchanged per AAP 0.8.1 Minimal Change Clause
//   - All method signatures, XML documentation, and namespace preserved exactly
