...
// .NET 10 Migration: Removed 'using Spring.Rest.Client;' and 'using Spring.Http;' — Spring.NET
// libraries have no .NET 10 equivalent. This is a dormant Enterprise Edition stub that must
// compile on .NET 10 but is NOT expected to execute. Per AAP 0.8.1 Minimal Change Clause.
