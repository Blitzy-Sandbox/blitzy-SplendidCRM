...
namespace Spring.Social.Facebook.Api
{
	...
	// MIGRATION: Removed #if !SILVERLIGHT / #endif preprocessor directives around [Serializable].
	// [Serializable] is now applied unconditionally — Silverlight is not a supported target on .NET 10.
	[Serializable]
	public class Event
	{
