...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/IQuestionOperations.cs
// .NET Framework 4.8 → .NET 10 ASP.NET Core migration (AAP Goal 5 / Section 0.7.4)
// REMOVED: using Spring.Rest.Client; — Spring.NET library discontinued, no .NET 10 equivalent
// REMOVED: using Spring.Http;        — Spring.NET library discontinued, no .NET 10 equivalent
