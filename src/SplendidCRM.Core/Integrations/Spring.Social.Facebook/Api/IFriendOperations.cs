...
// REMOVED: using Spring.Rest.Client; — Spring.Rest has no .NET 10 equivalent; dormant stub compile-only per AAP 0.7.4
// REMOVED: using Spring.Http; — Spring.Http has no .NET 10 equivalent; dormant stub compile-only per AAP 0.7.4
// KEPT: all System.* using directives per AAP 0.8.1 Minimal Change Clause
