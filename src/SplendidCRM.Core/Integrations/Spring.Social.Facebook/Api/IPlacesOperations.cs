...
// MIGRATION: Removed 'using Spring.Rest.Client;' and 'using Spring.Http;' — Spring.NET libraries
// have no .NET 10 equivalent. This dormant Enterprise Edition stub compiles on .NET 10 without
// those packages. All public interface contracts are preserved unchanged per AAP 0.8.1 Minimal
// Change Clause.
