...
// Removed: using Spring.Rest.Client; — Spring.REST framework removed; types referenced in XML docs only
// Removed: using Spring.Http; — Resource now resolves to local Spring.Social.Facebook.Api.Resource DTO class
