...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/Impl/LikeTemplate.cs
...
//   - ADDED:   using Spring.Social.Facebook.Api; — resolves ILikeOperations, Page, Reference
//              from the parent namespace (previously resolved via Spring.* DLL namespace lookup)
//   - KEPT:    All using System.* imports, Apache License header, namespace, class, PAGE_FIELDS
//              constant, constructor, and all ILikeOperations method implementations exactly.
