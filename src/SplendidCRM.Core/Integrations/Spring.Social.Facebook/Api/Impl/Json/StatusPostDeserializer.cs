...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/Impl/Json/StatusPostDeserializer.cs
...
//     JsonValue, IJsonDeserializer, and JsonMapper stubs are defined in
//     Spring.Social.Facebook.Api.Impl namespace (AbstractFacebookOperations.cs)
//     and are resolved via C# namespace scope resolution from this child namespace.
//   - KEPT: All other using directives, class declaration, method bodies, and
//     license header preserved exactly per AAP §0.8.1 Minimal Change Clause.
