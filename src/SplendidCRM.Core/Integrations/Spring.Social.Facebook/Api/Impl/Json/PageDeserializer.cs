...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/Impl/Json/PageDeserializer.cs
...
//     AbstractFacebookOperations.cs (namespace Spring.Social.Facebook.Api.Impl) and
//     resolve automatically via C# parent-namespace lookup from this child namespace.
//     Page and Location resolve from grandparent namespace Spring.Social.Facebook.Api.
//   - KEPT: all other using directives, Apache License header, XML doc comments,
//     namespace declaration, class signature, and complete Deserialize method body.
