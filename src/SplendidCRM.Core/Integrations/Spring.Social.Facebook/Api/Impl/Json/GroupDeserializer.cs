...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/Impl/Json/GroupDeserializer.cs
...
//   - KEPT: using System; and using System.Globalization; preserved per AAP §0.8.1 Minimal Change Clause
//   - All types (IJsonDeserializer, JsonValue, JsonMapper) resolve from stub definitions in
//     Spring.Social.Facebook.Api.Impl namespace (AbstractFacebookOperations.cs) via C# parent
//     namespace resolution. Group and Reference resolve from Spring.Social.Facebook.Api namespace.
//     JsonUtils resolves directly within Spring.Social.Facebook.Api.Impl.Json (same namespace).
