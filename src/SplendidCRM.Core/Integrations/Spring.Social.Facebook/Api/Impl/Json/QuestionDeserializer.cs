...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/Impl/Json/QuestionDeserializer.cs
...
//     Spring.Social.Facebook.Api.Impl namespace (AbstractFacebookOperations.cs) and
//     resolve via C# parent-namespace lookup from Spring.Social.Facebook.Api.Impl.Json.
//   - KEPT: All using System.* imports, Apache license, namespace, class, and ALL method bodies.
