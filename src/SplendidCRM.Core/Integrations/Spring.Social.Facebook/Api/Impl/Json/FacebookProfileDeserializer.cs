...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/Impl/Json/FacebookProfileDeserializer.cs
...
//   - KEPT: All class/method signatures, field mappings, and business logic preserved exactly.
//   - IJsonDeserializer, JsonValue, and JsonMapper stubs resolve from parent namespace
//     Spring.Social.Facebook.Api.Impl (defined in AbstractFacebookOperations.cs) via
//     C# enclosing namespace resolution — no explicit using directive needed.
//   - FacebookProfile, Reference, WorkEntry, EducationEntry DTOs resolve from grandparent
//     namespace Spring.Social.Facebook.Api via C# enclosing namespace resolution.
