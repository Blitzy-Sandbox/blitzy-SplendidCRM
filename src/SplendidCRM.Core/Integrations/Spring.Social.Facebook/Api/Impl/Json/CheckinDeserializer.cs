...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/Impl/Json/CheckinDeserializer.cs
...
//   - IJsonDeserializer, JsonValue, and JsonMapper resolve from parent namespace
//     Spring.Social.Facebook.Api.Impl (defined in AbstractFacebookOperations.cs)
//     via C# namespace hierarchy resolution — no using directive required.
//   - Checkin, Reference, Page, and Comment DTOs resolve from ancestor namespace
//     Spring.Social.Facebook.Api via C# namespace hierarchy resolution.
//   - KEPT: All other using directives, class/method signatures, and method bodies
