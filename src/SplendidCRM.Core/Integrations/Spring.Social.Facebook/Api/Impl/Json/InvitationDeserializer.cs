...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/Impl/Json/InvitationDeserializer.cs
...
//              IJsonDeserializer, JsonValue, and JsonMapper are now provided as stubs
//              in AbstractFacebookOperations.cs (namespace Spring.Social.Facebook.Api.Impl)
//              and resolve via C# parent-namespace resolution.
//   - KEPT: All other using directives, namespace, class, and ALL method bodies exactly.
