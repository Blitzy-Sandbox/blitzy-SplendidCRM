...
// Migrated from SplendidCRM/_code/Spring.Social.Facebook/Api/Impl/Json/PhotoDeserializer.cs
...
//     accessible here via C# parent-namespace resolution.
//   - KEPT: All other using directives, class signature, method bodies, license header,
//     XML doc comments, and code formatting preserved exactly per AAP §0.8.1 (Minimal Change).
