...
using System;
using System.Data;
// Removed: using Spring.Rest.Client; — Spring.Rest is discontinued with no .NET 10 equivalent.
// IApiBinding is now defined as a local stub interface below (see Spring.Social.Core replacement).
using System.Collections.Generic;

namespace Spring.Social.QuickBooks.Api
{
	// Stub interface replacing Spring.Social.Api.IApiBinding (no .NET 10 equivalent).
	// Preserved for Enterprise Edition upgrade path compatibility.
	// Migration note: Spring.Social.Core has no .NET Core/.NET 10 NuGet package;
	// the minimal IApiBinding contract (IsAuthorized) is reproduced here verbatim.
