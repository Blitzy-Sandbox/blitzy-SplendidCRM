...
namespace Spring.Social.Twitter.Api
{
    ...
    public interface ITimelineOperations
    {
        ...
        /// </returns>
        /// <exception cref="TwitterApiException">If there is an error while communicating with Twitter.</exception>
        RestOperationCanceler RetweetAsync(long tweetId, Action<RestOperationCompletedEventArgs<Spring.Http.HttpResponseMessage>> operationCompleted);
        ...
        /// </returns>
        /// <exception cref="TwitterApiException">If there is an error while communicating with Twitter.</exception>
        RestOperationCanceler AddToFavoritesAsync(long tweetId, Action<RestOperationCompletedEventArgs<Spring.Http.HttpResponseMessage>> operationCompleted);
        ...
        /// </returns>
        /// <exception cref="TwitterApiException">If there is an error while communicating with Twitter.</exception>
        RestOperationCanceler RemoveFromFavoritesAsync(long tweetId, Action<RestOperationCompletedEventArgs<Spring.Http.HttpResponseMessage>> operationCompleted);
#endif
    }
}
