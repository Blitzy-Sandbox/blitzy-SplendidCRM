    ...
    class TwitterProfileDeserializer : IJsonDeserializer
    {
        ...
        public object Deserialize(JsonValue value, JsonMapper mapper)
        {
            return new TwitterProfile()
            {
                ...
                NotificationsEnabled = value.GetValueOrDefault<bool>("notifications"),
                ...
                Following = value.GetValueOrDefault<bool>("following"),
                FollowRequestSent = value.GetValueOrDefault<bool>("follow_request_sent"),
                IsProtected = value.GetValueOrDefault<bool>("protected"),
                Verified = value.GetValueOrDefault<bool>("verified"),
                GeoEnabled = value.GetValueOrDefault<bool>("geo_enabled"),
                ContributorsEnabled = value.GetValueOrDefault<bool>("contributors_enabled"),
                ...
                BackgroundImageTiled = value.GetValueOrDefault<bool>("profile_background_tile"),
