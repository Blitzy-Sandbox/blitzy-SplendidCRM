#nullable disable
// Migration note: Added #nullable disable — source was written for .NET Framework 4.8 which lacks
// nullable reference type annotations. Preserved per AAP §0.8.1 minimal change clause.
#region License
...
// Migration note: HttpMethod alias required for .NET 10 — ImplicitUsings introduces System.Net.Http.HttpMethod
// which conflicts with Spring.Http.HttpMethod used throughout this file. Alias resolves ambiguity.
// Per AAP §0.8.1 minimal change clause (only migration-required changes applied).
using HttpMethod = Spring.Http.HttpMethod;
