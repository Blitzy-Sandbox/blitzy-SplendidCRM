...
// .NET 10 Migration: Migrated from SplendidCRM/_code/Spring.Social.Twitter/Connect/TwitterServiceProvider.cs.
// Spring.Social.OAuth1 (AbstractOAuth1ServiceProvider<T> and OAuth1Template) stub types are defined
// in the Spring.Social.OAuth1 namespace block within
// src/SplendidCRM.Core/Integrations/Spring.Social.LinkedIn/Connect/LinkedInServiceProvider.cs,
// compiled into the same SplendidCRM.Core assembly per AAP Section 0.7.4 Spring.Social Dependency Removal.
// The using directive references those shared stub types — no redefinition needed here.
