...
// discontinued with no .NET Core / .NET 10 equivalent NuGet package. Stub types IJsonDeserializer,
// JsonValue, and JsonMapper are defined in the Spring.Social.Salesforce.Api.Impl namespace
// (AbstractSalesforceOperations.cs) and resolve via C# parent-namespace resolution without an
// explicit using directive. DescribeGlobalSObject resolves from the grandparent
// Spring.Social.Salesforce.Api namespace by the same mechanism.
// This is a dormant Enterprise Edition stub — compiles on .NET 10 but is NOT executed at runtime.
