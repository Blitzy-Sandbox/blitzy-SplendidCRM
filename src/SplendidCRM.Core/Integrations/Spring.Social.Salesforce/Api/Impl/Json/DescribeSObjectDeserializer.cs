...
// Spring.Json assembly (Spring.Rest.dll) is discontinued with no .NET Core/.NET 10 equivalent.
// IJsonDeserializer, JsonValue, and JsonMapper stub types are defined in
// Spring.Social.Salesforce.Api.Impl (AbstractSalesforceOperations.cs) and resolve into this
// Spring.Social.Salesforce.Api.Impl.Json child namespace without an explicit using directive.
// DescribeSObject, Field, RecordTypeInfo, and ChildRelationship resolve from the grandparent
// Spring.Social.Salesforce.Api namespace via C# namespace resolution rules.
// This is a dormant integration stub — compiles on .NET 10 but is NOT executed at runtime.
