...
// and unavailable on .NET 10. Stub replacements for IJsonDeserializer, JsonValue, and JsonMapper are
// defined in the parent namespace Spring.Social.Salesforce.Api.Impl (AbstractSalesforceOperations.cs)
// and are accessible from this child namespace via C# namespace resolution without explicit using
// directives. This is a dormant integration stub — compiles but is NOT expected to execute at runtime.
