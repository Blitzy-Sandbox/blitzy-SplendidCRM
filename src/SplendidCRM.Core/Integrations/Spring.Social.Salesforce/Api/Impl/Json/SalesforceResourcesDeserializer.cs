...
// .NET 10 Migration: Removed "using Spring.Json;" — Spring.NET Framework assemblies (discontinued)
// are unavailable on .NET 10. Stub types IJsonDeserializer, JsonValue, and JsonMapper are defined
// in the parent namespace Spring.Social.Salesforce.Api.Impl (AbstractSalesforceOperations.cs) and
// are accessible from this child namespace without an explicit using directive.
// SalesforceResources is defined in Spring.Social.Salesforce.Api and resolves via grandparent
// namespace lookup. This is a dormant integration stub — compiles but is NOT expected to execute.
