 ...
 *********************************************************************************************************************/
// NOTE: .NET 10 Migration — removed 'using Spring.Rest.Client;' (discontinued; no .NET 10 equivalent)
// NOTE: .NET 10 Migration — removed 'using Spring.Http;' (discontinued; no .NET 10 equivalent)
using System;
using System.IO;
