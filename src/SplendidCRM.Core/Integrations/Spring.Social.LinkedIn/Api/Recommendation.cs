...
// .NET 10 Migration: Removed #if !SILVERLIGHT / #endif preprocessor guards —
// [Serializable] is now applied unconditionally as Silverlight is not supported on .NET 10.
