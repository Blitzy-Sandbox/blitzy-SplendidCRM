...
// MIGRATION: using System.Threading.Tasks made unconditional for .NET 10.
// Previously guarded by #if NET_4_0 || SILVERLIGHT_5; the #else branch (Spring.Rest.Client,
// Spring.Http, synchronous methods, RestOperationCanceler callbacks) has been removed entirely
// as part of the .NET Framework 4.8 → .NET 10 ASP.NET Core migration.
