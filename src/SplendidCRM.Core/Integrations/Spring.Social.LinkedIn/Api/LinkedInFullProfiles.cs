...
namespace Spring.Social.LinkedIn.Api
{
    ...
    // Migrated to .NET 10: Removed #if !SILVERLIGHT / #endif guards; [Serializable] applied unconditionally.
    [Serializable]
	// 04/10/2012 Paul.  We need a new deserializer for the full profile. 
    public class LinkedInFullProfiles : PaginatedResult
    {
        /// <summary>
        /// Gets or sets the list of matching <see cref="LinkedInFullProfile"/>s.
        /// </summary>
