# -----------------------------------------------------------------------------
# SplendidCRM ECS Fargate — Dev Environment Variables
# -----------------------------------------------------------------------------
# Defines ALL Terraform input variables for the dev environment root module.
# These variables are populated by dev.auto.tfvars and consumed by main.tf
...
variable "name_prefix" {
  type        = string
  description = "Naming prefix for all resources (e.g., splendidcrm-dev). Used in resource names, tags, and log group paths following ACME naming convention: {app}-{env}."
}
