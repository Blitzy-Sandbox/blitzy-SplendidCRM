# -----------------------------------------------------------------------------
# SplendidCRM ECS Fargate — Dev Environment Variable Values
# -----------------------------------------------------------------------------
# Dev-specific Terraform variable values for the SplendidCRM ECS Fargate
...
# Docker image tag for ECR. Defaults to "latest" for dev; CI/CD pipelines
...
# Empty string disables the HTTPS listener — dev uses HTTP-only for local testing.
# Set to a valid ACM certificate ARN to enable TLS termination.
certificate_arn = ""
